...
const SphereAIResumeCard = ({ name, links, salutation, intro, story }) => {
  const commonProps = {
      ...
      <div className="scrollbar-hide overflow-y-scroll p-4 gap-4 flex flex-col">
        ...
        <Section heading={"Why I want to join your team?"}>
          <ul>
            ...
            <li>
              I am not happy with noraml interview process and the way that is
              executed in most of the companies. I feel this is a genuine issue
              and want to help in solving this so that no talented person is
              left behind.
            </li>
            <li>
...
export default SphereAIResumeCard;
